...
*/
  private static _systemMessage = (
    <UserMessage>
      ...
      8. If the text to be translated contains Markdown syntax, translate it to the corresponding LaTeX syntax, e.g., **text** is translated to \textbf{text}.
      8. Respect previous translations and ensure that the new translation is consistent with the previous one.
